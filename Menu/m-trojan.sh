...
echo -e "  ${ORANGE}2.${NC} \033[0;36m Create Trial XRAY Trojan WS/GRPC${NC}"
echo -e "  ${ORANGE}3.${NC} \033[0;36m Delete Account XRAY Trojan WS/GRPC${NC}"
echo -e "  ${ORANGE}4.${NC} \033[0;36m Renew Trojan Account${NC}"
echo -e "  ${ORANGE}5.${NC} \033[0;36m Check Trojan login Account${NC}"
echo -e "  ${ORANGE}6.${NC} \033[0;36m Check Config Trojan  Account${NC}"
echo -e "\033[1;93mâ””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜\033[0m"
echo -e ""
