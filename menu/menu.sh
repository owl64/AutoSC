...
echo -e " ${z}│$NC$r â€¢ $NC${z} Core System ${NC}   $Blue=$NC $CORE${NC}"
echo -e " ${z}│$NC$r â€¢ $NC${z} Server RAM ${NC}    $Blue=$NC $uram/$RAM MB $NC"
echo -e " ${z}│$NC$r â€¢ $NC${z} Uptime Server ${NC} $Blue=$NC $SERONLINE${NC}"
echo -e " ${z}│$NC$r â€¢ $NC${z} Domain ${NC}        $Blue=$NC $domain${NC}"
echo -e " ${z}│$NC$r â€¢ $NC${z} IP VPS ${NC}        $Blue=$NC $IPVPS${NC}"
echo -e " ${z}│$NC$r â€¢ $NC${z} ISP ${NC}           $Blue=$NC $ISP${NC}"
echo -e " ${z}│$NC$r â€¢ $NC${z} City ${NC}          $Blue=$NC $CITY${NC}"
#echo -e " ${z}│$NC$r â€¢ $NC${z} Uptime Server ${NC} $Blue=$NC $SERONLINE${NC}"
#echo -e " ${z}│$NC$r â€¢ $NC${z} Date ${NC}          $Blue=$NC $DATEVPS${NC}"
#echo -e " ${z}│$NC$r â€¢ $NC${z} Time ${NC}          $Blue=$NC $TIMEZONE${NC}"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
