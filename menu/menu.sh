...
#echo -e " ${z}│$NC$r □ $NC${z} Uptime Server ${NC} $Blue=$NC $SERONLINE${NC}"
#echo -e " ${z}│$NC$r □ $NC${z} Date ${NC}          $Blue=$NC $DATEVPS${NC}"
#echo -e " ${z}│$NC$r □ $NC${z} Time ${NC}          $Blue=$NC $TIMEZONE${NC}"
echo -e " ${z}└──────────────────────────────────────────────────────────┘${NC}"
echo -e "                  ${KIRI} ${purple}YOUR ACCOUNT ON VPS${NC} ${KANAN}"
echo -e " ${z}┌──────────────────────────────────────────────────────────┐${NC}"
echo -e "                  ${KIRI} SSH${NC}    $y:$NC $ssh1${NC}" "     VMESS${NC}  $y:$NC $vma$NC" "     VLESS${NC}  $y:$NC $vla$NC ${KANAN}"
