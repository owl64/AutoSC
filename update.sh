...
echo -e ""
            ...
            echo -e " ${z}┌──────────────────────────────────────────┐${NC}"
            echo -e ""
            echo -e "      ${YELLOW}[*] Updates will not disrupt the connection${NC}"
            ...
            echo -e "      ${BLUE}[*] ${YELLOW}Add Change IP Limit Vless ${NC}"
            echo -e "      ${BLUE}[*] ${YELLOW}Add Change QUOTA Limit Vless ${NC}"
            echo -e "      ${BLUE}[*] ${YELLOW}Add Reset Usage Quota Vless ${NC}"
            echo -e "      ${BLUE}[*] ${YELLOW}Show Amount Account and Quota/day [ Vmess, Vless] ${NC}"
            echo -e ""
            echo -e " ${z}└──────────────────────────────────────────┘${NC}"
